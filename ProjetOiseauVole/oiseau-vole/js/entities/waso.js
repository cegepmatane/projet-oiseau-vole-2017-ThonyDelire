...
function(	_,
	...
	var sonicImage = FLAPPYSONIC.loadQueue.getResult('waso');
	...
	*/
	...
	Waso.prototype = new createjs.Sprite(dataSonic, 'straight');

	Waso.prototype.initialize = function() {
	...
	Waso.prototype.glideDown = function(pixelsPerDelta) {
